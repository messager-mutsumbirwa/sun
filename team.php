    ...
    <div class="row justify-content-center">
      <div class="col-lg-3 col-sm-6 mb-5">
        <div class="ts-team-wrapper">
          ...
          <div class="ts-team-content-classic">
            <h3 class="ts-name">CHRISTIAN AKILI</h3>
            <p class="ts-designation">DIRECTEUR GENERALr</p>
            <p class="ts-description">Ingenieuren de conception en Genie Civil,mais aussi Architect d interieur </p>
      ...
      <div class="col-lg-3 col-sm-6 mb-5">
        <div class="ts-team-wrapper">
          ...
          <div class="ts-team-content-classic">
            <h3 class="ts-name">CHRISTIAN LIKUMBI </h3>
            <p class="ts-designation">Ingenieur en batiment  et en travaux publique</p>
    ...
    <div class="row">
      <div class="col-lg-3 col-md-4 col-sm-6 mb-5">
        <div class="ts-team-wrapper">
          ...
          <div class="ts-team-content-classic">
            <h3 class="ts-name">Benjamin Kyamakya </h3>
            <p class="ts-designation">Ingenieur en batiment et travaux publique </p>
            <p class="ts-description">Nats Stenman began his career in construction with boots on the ground</p>
            <div class="team-social-icons">
              <a target="_blank" href="#"><i class="fab fa-facebook-f"></i></a>
              <a target="_blank" href="#"><i class="fab fa-twitter"></i></a>
