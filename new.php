      ...
      <div class="col-lg-4 order-1 order-lg-0">
          ...
          
        {
          ...
          <div class="posts-thumb">
            ...
            <a><input type="image" loading="lazy" alt="img" src="../sun/img/'.$donnees['image'].'""></a>
          </div>
          <div class="post-info">
            <h4 class="entry-title">
              <a href="#">'.$donnees['nameitem'].'</a>
       ...
       echo'
        ...
        <div class="post">
          ...
          <input type="hidden" name="id" value="'.$donnees['id_fournisseur'].'">
            ...
            <input type="image" loading="lazy" alt="img"  class="img-fluid" src="../sun/img/'.$donnees['image'].'"></a>
          ...
          <div class="post-body">
            <div class="entry-header">
              ...
              <h2 class="entry-title">
                <a href="news-single.html">'.$donnees['nameitem'].'</a>
              </h2>
