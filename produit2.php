...
<?php
	include('file:///C:/xampp/htdocs/sun/modele/entete2.php');
?>
<link rel="stylesheet" type="text/css" href="../sun/css/style.css">
	<div class="body-produit">
		<div class="produit-container">
			<div class="produit-infos">
				<?php

					require_once '../sun/controleur/control.php'; 
			...
			<form action="identification2.php" method="POST">
				...
				<div class="produit-imgprincipal">
					<input type="image" src="../sun/img/<?php echo htmlspecialchars($image); ?>">
				</div>
		...
		<div class="sidebar-produit">
			<h2>Images referenciel du Batiment</h2>
			<div class="produit-img">
				<img src="../sun/img/<?php echo htmlspecialchars($image1); ?>">
				<img src="../sun/img/<?php echo htmlspecialchars($image2); ?>">
				<img src="../sun/img/<?php echo htmlspecialchars($image3); ?>">
				<img src="../sun/img/<?php echo htmlspecialchars($image4); ?>">
			</div>
		</div>
	</div>
<?php
