    ...
    <div class="row">
      <div class="col-12">
        ...
        <div class="row shuffle-wrapper">
          ...
          require_once 'file:///C:/xampp/htdocs/sun/Admin/modele/liste2.php';
          require_once 'file:///C:/xampp/htdocs/sun/controleur/liste2.php';
          while ($donnees = $reponse->fetch())
          {
            ...
            <form action="../sun/modele/produit2.php" method="POST">
              ...
              <a class="gallery-popup" >
                ...
                <input type="image" class="img-fluid" src="../sun/img/'.htmlspecialchars($donnees['image']).'" alt="project-image">
        ...
        ?>
          ...
          <div class="col-lg-4 col-md-6 shuffle-item" data-groups="[&quot;residential&quot;]">
            <div class="project-img-container">
              <a class="gallery-popup" <?php
           require_once'file:///C:/xampp/htdocs/sun/Admin/modele/connect_bd.php';
          require_once 'file:///C:/xampp/htdocs/sun/modele/liste2.php';
          require_once 'file:///C:/xampp/htdocs/sun/controleur/liste2.php';
          while ($donnees = $reponse->fetch())
          {
